					...
					<Card.Content>
						<p className="prose">
							...
							<p>
								...
								compliance with any applicable local laws. If
								you do not agree with any of these terms, you
								are prohibited from using or accessing this
								site. The materials contained in this website
								are protected by applicable copyright and
								trademark law.
							</p>
							<h3>2. Use License</h3>
							<ol type="a">
								<li>
									...
									(information or software) on Makerlog's
								...
								<li>
									...
									may be terminated by Makerlog at any time.
									Upon terminating your viewing of these
							...
							<ol type="a">
								<li>
									The materials on Makerlog's website are
									provided on an 'as is' basis. Makerlog makes
									no warranties, expressed or implied, and
								...
								<li>
									Further, Makerlog does not warrant or make
									any representations concerning the accuracy,
									likely results, or reliability of the use of
									the materials on its website or otherwise
							...
							<h3>4. Limitations</h3>
							<p>
								In no event shall Makerlog or its suppliers be
								...
								Makerlog's website, even if Makerlog or a
								Makerlog authorized representative has been
								notified orally or in writing of the possibility
								of such damage. Because some jurisdictions do
							...
							<p>
								The materials appearing on Makerlog's website
								could include technical, typographical, or
								photographic errors. Makerlog does not warrant
								that any of the materials on its website are
								accurate, complete or current. Makerlog may make
								changes to the materials contained on its
								website at any time without notice. However
								Makerlog does not make any commitment to update
								the materials.
							</p>
							<h3>6. Links</h3>
							<p>
								Makerlog has not reviewed all of the sites
								...
								by Makerlog of the site. Use of any such linked
								website is at the user's own risk.
							</p>
							<h3>7. Modifications</h3>
							<p>
								Makerlog may revise these terms of service for
							...
							<p>
								...
								construed in accordance with the laws of Puerto
								Rico and you irrevocably submit to the exclusive
					...
					<Card.Content>
						<div className="prose">
							<p>
								...
								regarding any information we may collect from
