						...
						<div className="Post">
							...
							<div className="object px-4 py-4 pt-0 ">
								...
								<p className="text-gray-700 ml-2 p-4 border-l border-gray-200">
									I love doing what I do. Today I basically
									completed an amazing new part of the
									Makerlog infrastructure, and I'm really
									happy about it. I'm making a lot of progress
									lately!
								</p>
							</div>
								...
								<span className="inline-flex rounded-md">
									<span className="mr-2">
										<Button sm>
											...
											<span className="mr-2">Praise</span>
											<FaceStack
												size={4}
												users={[
													{
